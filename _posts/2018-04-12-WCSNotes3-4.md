...
* Carrier Frequency Offset (CFO)
    ...
    * <span style="color: red">**CFO 是用來作時域 (time-domain) 上的訊號校正。**</span>
...
* Sample Frequency Offset (SFO)
    ...
    * <span style="color: red">**SFO 是用來作頻域 (frequency-domain) 上的訊號校正。**</span>
...
* 在實際的訊號傳遞過程，Tx 和 Rx 的振盪器 (oscillator) 不會有良好的同步。
    ...
    * <span style="color: red">**導致 carrier 之間彼此的互相干擾，稱作「載波間干擾 (inter-carrier interference; ICI)」。**</span>
* **OFDM 對於 ICI 相當敏感。**
...
* 如何估算 CFO？
    ...
    * 對於 Rx 而言，將通頻訊號 (passband signal) $$s(t)$$ 進行**「降頻轉換 (down-conversion)」**至基頻訊號 (baseband signal)。
        ...
        \end{align*}
        $$
    * 由上式可以得，<span style="color: red">**CFO 所造成的錯誤會隨著時間累積 $$nT_s$$**</span>。
...
* 在 preamble 中，前半部分和後半部份相同。
    ...
    * 如下圖所示，接收端連續收到的兩個 symbols 分別為 $$y_n$$ 和 $$y_{n+N}$$。
        ...
        * 如下式，<span style="color: red">**透過 $$y_{n+N} / y_n$$ 找到 $$\Delta_f$$。**</span>其中，$$y^*_n+N$$ 為 $$y_{n+N}$$ 的倒數。
            $$
            \begin{align*}
...
* 由下圖可以看出，<span style="color: red">**SFO 在 I-Q 平面上的意義是「斜率的變化」，而 CFO 是 「$$y$$ 軸的截距」。**</span>
