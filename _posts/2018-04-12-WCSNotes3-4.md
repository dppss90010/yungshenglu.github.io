---
layout     : post
title      : "Overview of OFDM(3) - Synchronozation"
subtitle   : "無線通訊系統學習雜記"
...
* 在 preemble 中，前半部分和後半部份相同。
    ...
    * 如下圖所示，接收端連續收到的兩個 symbols 分別為 $$y_n$$ 和 $$y_{n+N}$$。
        ...
        * 如下式，**透過 $$y_{n+N} / y_n$$ 找到 $$\Delta_f$$。**其中，$$y^*_n+N$$ 為 $$y_{n+N}$$ 的倒數。
            ![](https://i.imgur.com/pmQfBAI.png)
        * 上式中的<font color=blue>藍色</font>部分，可以學到 CFO $$\Delta_f$$
            ![](https://i.imgur.com/hwaBDt5.png)
        * 將相位旋轉的部分移掉，就可以校正訊號。
